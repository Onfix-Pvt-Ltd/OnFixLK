...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    text: `bg-transparent text-text-dark px-4 py-2 hover:text-accent hover:translate-x-[3px]`,
  };
